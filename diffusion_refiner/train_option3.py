...
def save_uncertainty_figure(
    ...
    # Do not over-normalize the mean mask. This prevents noisy rendering.
    ...
    # Show uncertainty mainly near vessel-like regions.
...
if __name__ == "__main__":
    ...
    #python -m diffusion_refiner.train_option3
